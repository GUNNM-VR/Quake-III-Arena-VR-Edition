...
//Quake 3 1.31 uses protocol 67
//Quake 3 1.32 uses protocol 68
//Open Arena up to 0.7.6 uses protocol 68
//Open Arena 0.7.7 uses protocol 69
//Open Arena 0.8.0 uses protocol 70
//Open Arena 0.8.1+ uses protocol 71
...
#ifdef USE_NATIVE_HACK
typedef intptr_t (QDECL *vmMainFunc_t) ( int command, int arg0, int arg1, int arg2, int arg3, int arg4 );
#else
